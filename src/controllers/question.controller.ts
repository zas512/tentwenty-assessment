...
// POST /contests/:id/questions — admin only
export const addQuestion = async (req: Request, res: Response) => {
  ...
  // single select must have exactly 1 correct option
  if (
...
// GET /contests/:id/questions — all questions for a contest
...
// PUT /contests/:id/questions/:questionId — admin only
export const updateQuestion = async (req: Request, res: Response) => {
  ...
  // if updating options, validate based on existing type
...
// DELETE /contests/:id/questions/:questionId — admin only
